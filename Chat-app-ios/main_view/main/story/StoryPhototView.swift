                                ...
                                Button(action: {
                                    withAnimation{
                                        ...
                                        case .center:
                                            ...
                                            var widthOfText = drawVM.storySubItems[drawVM.textEditIndex != -1 ? drawVM.textEditIndex : drawVM.currentIndex].text.widthOfString(usingFont: .systemFont(ofSize: 20))
                                       
                                            if drawVM.storySubItems[drawVM.textEditIndex != -1 ? drawVM.textEditIndex : drawVM.currentIndex].itemSize.width != .zero {
                                                widthOfText = drawVM.storySubItems[drawVM.textEditIndex != -1 ? drawVM.textEditIndex : drawVM.currentIndex].itemSize.width
                                            }
                                            DispatchQueue.main.async{
                                                let newLeadingOffset = leadingAignment + widthOfText / 2
                                                drawVM.storySubItems[drawVM.textEditIndex != -1 ? drawVM.textEditIndex : drawVM.currentIndex].lastOffset.width = newLeadingOffset
                                                drawVM.storySubItems[drawVM.textEditIndex != -1 ? drawVM.textEditIndex : drawVM.currentIndex].offset.width = newLeadingOffset
                                            }
                                        case .leading:
                                            ...
                                            DispatchQueue.main.async{
                                                let newTralingOffset = tralingAignment - widthOfText / 2
                                                drawVM.storySubItems[drawVM.textEditIndex != -1 ? drawVM.textEditIndex : drawVM.currentIndex].lastOffset.width = newTralingOffset
                                                drawVM.storySubItems[drawVM.textEditIndex != -1 ? drawVM.textEditIndex : drawVM.currentIndex].offset.width = newTralingOffset
                                            }
                                            drawVM.storySubItems[drawVM.textEditIndex != -1 ? drawVM.textEditIndex : drawVM.currentIndex].textAlignment = .trailing
                                        case .trailing:
                                            DispatchQueue.main.async{
                                                drawVM.storySubItems[drawVM.textEditIndex != -1 ? drawVM.textEditIndex : drawVM.currentIndex].lastOffset.width = 0 //set back to 0
                                                drawVM.storySubItems[drawVM.textEditIndex != -1 ? drawVM.textEditIndex : drawVM.currentIndex].offset.width = 0
                                            }
